...
<head>
    ...
    <title>Privacy Policy | HyperMart</title>
...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 py-12">
        <div class="bg-white rounded-lg shadow-lg p-8 md:p-12">
            <h1 class="text-4xl font-bold text-gray-900 mb-2 font-display">Privacy Policy</h1>
            ...
            <div class="prose prose-lg max-w-none text-gray-700 space-y-6">
                ...
                <section>
                    ...
                    <p>HyperMart uses the collected data for various purposes:</p>
                    <ul class="list-disc list-inside space-y-2 mt-3">
                ...
                <section>
                    ...
                    <ul class="list-disc list-inside space-y-2 mt-3">
                        <li>By email: <strong>privacy@hypermart.com</strong></li>
                        <li>By phone: <strong>1-800-HYPERMART</strong></li>
                        <li>By mail: HyperMart Customer Support, 123 Shopping Street, Commerce City, CC 12345</li>
                    </ul>
                </section>
