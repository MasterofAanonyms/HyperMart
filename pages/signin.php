    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="auth-card rounded-3xl shadow-2xl p-8 md:p-10">
            ...
            <form id="signinForm" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <span class="password-toggle absolute right-4 top-1/2 -translate-y-1/2 text-gray-400" onclick="togglePassword('password')">
            ...
            <p class="text-center mt-8 text-gray-600">
                ...
                <a href="signup.php" class="text-brand-orange font-semibold hover:underline">Sign Up</a>
            </p>
