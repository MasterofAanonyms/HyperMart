        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="relative group dropdown-container">
                    <a href="hi.php" id="user-menu-btn"
                        class="text-black hover:text-brand-yellow transition-transform hover:scale-110 duration-200 p-2 rounded-full hover:bg-gray-50 flex items-center justify-center">
                        <img src="../public/images/icons/user.svg" alt="User" class="w-8 h-8 sm:w-9 sm:h-9">
                    </a>
                    <!-- Dropdown Menu Wrapper (helps prevent hover loss) -->
                    <div id="user-dropdown"
                        class="absolute right-0 top-full pt-2 w-64 invisible opacity-0 translate-y-2 group-hover:visible group-hover:opacity-100 group-hover:translate-y-0 z-50 transition-all duration-300 ease-out">
                        <div class="bg-white rounded-2xl shadow-xl p-2 border border-gray-100">
                            <ul class="flex flex-col text-gray-700">
                                <li><a href="hi.php"
                                        class="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 rounded-xl transition-colors font-medium text-gray-700 hover:text-brand-orange">
                                ...
                                <li><a href="../index.php#summer-offers"
                                        class="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 rounded-xl transition-colors font-medium text-gray-700 hover:text-brand-orange">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="w-5 h-5 opacity-70">
                                            <path stroke-linecap="round" stroke-linejoin="round"
